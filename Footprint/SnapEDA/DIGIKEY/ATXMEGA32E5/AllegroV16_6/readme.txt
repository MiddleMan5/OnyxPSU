...
All files exported to: C:\EMA\ExportFolder\7609\Output\AllegroV16_6\AllegroV16_6
...
Component "ATXMEGA32E5-AU" renamed to "ATXMEGA32E5-AU"


Ultra Librarian Gold 8.1.230 Process Report


Message - Pattern "32A", entity (534-LINE) is a LINE with matching start and end points.
Message - Pattern "32A", entity (536-LINE) is a LINE with matching start and end points.
Message - Pattern "32A", entity (538-LINE) is a LINE with matching start and end points.
Message - Pattern "32A", entity (540-LINE) is a LINE with matching start and end points.
Message - Pattern "32A-M", entity (534-LINE) is a LINE with matching start and end points.
Message - Pattern "32A-M", entity (536-LINE) is a LINE with matching start and end points.
Message - Pattern "32A-M", entity (538-LINE) is a LINE with matching start and end points.
Message - Pattern "32A-M", entity (540-LINE) is a LINE with matching start and end points.
Message - Pattern "32A-L", entity (534-LINE) is a LINE with matching start and end points.
Message - Pattern "32A-L", entity (536-LINE) is a LINE with matching start and end points.
Message - Pattern "32A-L", entity (538-LINE) is a LINE with matching start and end points.
Message - Pattern "32A-L", entity (540-LINE) is a LINE with matching start and end points.
