...
All files exported to: C:\EMA\ExportFolder\8213\Output\AllegroV16_6\AllegroV16_6
...
Component "FSMSM" renamed to "FSMSM"


Ultra Librarian Gold 8.1.230 Process Report


Message - Pattern "SWITCH_FSMSM", entity (142-LINE) is a LINE with matching start and end points.
Message - Pattern "SWITCH_FSMSM", entity (144-LINE) is a LINE with matching start and end points.
Message - Pattern "SWITCH_FSMSM", entity (147-LINE) is a LINE with matching start and end points.
Message - Pattern "SWITCH_FSMSM", entity (149-LINE) is a LINE with matching start and end points.
